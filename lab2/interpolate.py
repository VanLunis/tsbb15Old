...
def interpolImage(Im, Jgdx, Jgdy, du):
    '''
    ...
    newIm = intepShift(Im, [du[1], du[0]], mode='nearest')
    newDx = intepShift(Jgdx, [du[1], du[0]], mode='nearest')
    newDy = intepShift(Jgdy, [du[1], du[0]], mode='nearest')
